    ...
    <div>
      ...
      {addOpen && (
        <div style={{ background: "var(--wt-card-bg)", border: "1px solid #F7931A44", borderRadius: 6, padding: 20, marginBottom: 20 }}>
          <div style={{ fontSize: 11, color: "var(--wt-text-muted)", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 14 }}>New Watched Address</div>
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            <div>
              <div style={{ fontSize: 10, color: "var(--wt-text-dim)", letterSpacing: "0.08em", marginBottom: 4 }}>LABEL</div>
              <input 
            ...
            <div style={{ display: "flex", gap: 8, justifyContent: "flex-end", marginTop: 4 }}>
              <button onClick={() => setAddOpen(false)} style={{ background: "transparent", border: "1px solid var(--wt-border)", color: "var(--wt-text-muted)", fontFamily: "inherit", fontSize: 11, padding: "6px 14px", borderRadius: 4, cursor: "pointer" }}>CANCEL</button>
              <button 
                onClick={handleWatch}
